...
parser.add_argument('--root', default='F:/', type=str)
...
parser.add_argument('--submission', default='result', type=str)
...
parser.add_argument('--test_date', default='2024-04-26', type=str)
...
def main():
    ...
    valid_root = 'F:/'
    valid_set = BraTS(valid_list, valid_root, 'test')
